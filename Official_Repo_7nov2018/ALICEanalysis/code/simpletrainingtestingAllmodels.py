...
from BinaryMultiFeaturesClassification import getgridsearchparameters,getDataMCfiles,getTreeName,prepareMLsample,getvariablesBoundaries
from VariablesDmesons import getvariablestraining,getvariablesothers,getvariableissignal,getvariablesall,getvariablecorrelation
...
# ----- mfaggin adaptation -----
suffix="SignalN%dBkgN%dPreMassCut" % (nevents,nevents)
...
if (doRoCLearning==1):
  #confusion(mylistvariables,names,classifiers,suffix,X_train,y_train,5,plotdir)
