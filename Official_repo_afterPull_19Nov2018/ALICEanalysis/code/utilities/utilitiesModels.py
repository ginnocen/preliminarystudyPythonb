...
def getclassifiers(MLtype):
  ...
  if (MLtype=="BinaryClassification"):
    classifiers = [
      GradientBoostingClassifier(learning_rate=0.03, n_estimators=2500, max_depth=2),RandomForestClassifier(max_depth=5, n_estimators=10, max_features=1), AdaBoostClassifier(),DecisionTreeClassifier(max_depth=5)
