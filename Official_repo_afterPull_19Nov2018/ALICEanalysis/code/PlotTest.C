...
void PlotTest()
{
    TString stroutdir = "output_Nevents50000_BinaryClassificationDs_dfselection_pt_cand_ML_0.0_100.0";
    vector<TString> models = {"ScikitGradientBoostingClassifier","ScikitRandom_Forest","ScikitAdaBoost","ScikitDecision_Tree","XGBoostXGBClassifier"};
    TString inputfilename(TString::Format("%s/testsampleNevents50000_BinaryClassificationDs_dfselection_pt_cand_ML_0.0_100.0MLdecision.root",stroutdir.Data()));
