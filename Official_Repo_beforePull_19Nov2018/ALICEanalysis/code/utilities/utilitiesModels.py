...
def getclassifiers():
  classifiers = [
    GradientBoostingClassifier(learning_rate=0.05, n_estimators=2000, max_depth=4),RandomForestClassifier(max_depth=5, n_estimators=10, max_features=1), AdaBoostClassifier(n_estimators=100),DecisionTreeClassifier(max_depth=5)
