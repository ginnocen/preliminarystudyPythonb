...
#   confusion(mylistvariables,names,classifiers,suffix,X_train,y_train,5)
  ...
  plot_learning_curves(names,classifiers,suffix,plotdir,X_train,y_train,500,nevents,4000)
...
if (doimportance==1):
  ...
  #mylistvariables_pca=["princ_comp_%d"%i for i in range(1,8)]
  #importanceplotall(mylistvariables_pca,names,classifiers,suffix,plotdir)
